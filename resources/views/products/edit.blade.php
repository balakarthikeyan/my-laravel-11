    ...
    <div class="card-body">
        ...
        <form action="{{ route('products.update',$product->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('details') is-invalid @enderror" style="height:150px" name="details" id="inputDetail" placeholder="Detail">{{ $product->details }}</textarea>
                @error('details')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
